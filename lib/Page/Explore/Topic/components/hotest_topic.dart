...
class HotestTopic extends StatelessWidget {
  HotestTopic(this.data, {super.key});
  late TopicList data;

  List<Widget> _buildHotestTopicTileList(BuildContext context) {
    List<Widget> widgets = [];
  ...
  Widget _buildHotestTile(BuildContext context) {
    List<Widget> widgets = _buildHotestTopicTileList(context);
    return Row(
      children: [
        Expanded(
            child: Wrap(
